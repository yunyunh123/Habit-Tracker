...
// displaying title
  ...
  // test if the 2 and 4 textbox values can be converted 
  // to float (amount) and frequency(integer)
  // do not close window until these things are valid
  // pup up error message saying to enter appropriate values
  // replace the bottom instructions to error message
